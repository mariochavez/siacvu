...
namespace DecisionesInteligentes.Colef.Sia.Core.NHibernateValidator {
    ...
    internal class SpanishValidatorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to El nombre de la entidad ya existe.
        /// </summary>
        internal static string Provided_values_matched_an_existing__duplicate_entity {
            get {
                return ResourceManager.GetString("Provided values matched an existing, duplicate entity", resourceCulture);
            }
        }
