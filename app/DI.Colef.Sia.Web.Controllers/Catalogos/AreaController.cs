...
namespace DecisionesInteligentes.Colef.Sia.Web.Controllers
{
    ...
    public class AreaController : BaseController<Area, AreaForm>
    {
        ...
        public AreaController(ICatalogoService catalogoService, IAreaMapper areaMapper) 
        {
        ...
        public ActionResult Create(AreaForm form)
        {
            ...
            return RedirectToIndex(String.Format("{0} ha sido creado", area.Nombre));
        }
        ...
        public ActionResult Update(AreaForm form)
        {
            ...
            return RedirectToIndex(String.Format("{0} ha sido modificado", area.Nombre));
        }
