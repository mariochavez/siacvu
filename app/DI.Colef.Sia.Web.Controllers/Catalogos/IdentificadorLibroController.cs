...
namespace DecisionesInteligentes.Colef.Sia.Web.Controllers
{
    ...
    public class IdentificadorLibroController : BaseController<IdentificadorLibro, IdentificadorLibroForm>
    {
        ...
        public IdentificadorLibroController(IUsuarioService usuarioService, ICatalogoService catalogoService, IIdentificadorLibroMapper identificadorLibroMapper) 
			: base (usuarioService)
        {
