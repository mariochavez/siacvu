...
namespace DecisionesInteligentes.Colef.Sia.Web.Controllers.Catalogos
{
    ...
    public class FormaParticipacionController : BaseController<FormaParticipacion, FormaParticipacionForm>
    {
        ...
        public ActionResult Create(FormaParticipacionForm form)
        {
            ...
            return RedirectToIndex(String.Format("Forma de Participación {0} ha sido creada", formaParticipacion.Nombre));
        }
        ...
        public ActionResult Update(FormaParticipacionForm form)
        {
            ...
            return RedirectToIndex(String.Format("Forma de Participación {0} ha sido modificada", formaParticipacion.Nombre));
        }
