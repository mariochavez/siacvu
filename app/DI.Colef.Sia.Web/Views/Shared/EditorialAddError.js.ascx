...
$('#mensaje-error').text('Se han generado ' + $('span.field-validation-error').length + ' error(es) al realizar la operacion, por favor corrijalos. La editorial no puse ser agregada.');
