...
<asp:Content ID="titleContent" ContentPlaceHolderID="TituloPlaceHolder" runat="server">
    <h2>
        <%=Html.ProductoEditTitle(TipoProductoEnum.Curso) %>
    </h2>
</asp:Content>
...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
	<div id="introduccion">
		<p>
            <%=Html.ProductoEditMessage(TipoProductoEnum.Curso) %>
		</p>
    ...
    <div id="barra">
        <div id="asistente">
	        ...
	        <% if(User.IsInRole("DGAA")){ %>
	            <h3>&Aacute;rea de validaci&oacute;n de producto</h3>
	            <% Html.RenderPartial("_CustomFirmaForm", new FirmaForm{Id = Model.Form.Id, IdName = "CursoId", Controller = "Curso", TipoProducto = 3}); %>
	        <% } %>
