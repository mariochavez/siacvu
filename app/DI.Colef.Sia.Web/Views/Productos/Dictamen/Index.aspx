...
<asp:Content ID="titleContent" ContentPlaceHolderID="TituloPlaceHolder" runat="server">
    <h2>
        <%=Html.ProductoListTitle(TipoProductoEnum.Dictamen) %>
    </h2>
</asp:Content>
...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        <h3>
            <%=Html.ProductoListSubTitle(TipoProductoEnum.Dictamen) %>
        </h3>
        <p>
            <%=Html.ProductoListMessage(TipoProductoEnum.Dictamen) %>
		</p>
        <div class="botonzon">
            <span><%=Html.ActionLink<DictamenController>(x => x.New(), "+ Nuevo")%></span>
        </div>
		...
		<% } else { %>
			<% foreach (var dictamen in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(dictamen.Id) %>">
					<div class="elementodescripcion">
					    <h5><span><%=Html.Encode(dictamen.Nombre)%></span></h5>
