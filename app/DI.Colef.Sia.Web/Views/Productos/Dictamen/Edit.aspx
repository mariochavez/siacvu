...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
	<div id="introduccion">
		<p>Para modificar el dictamen utilice los siguientes campos para realizar cambios dentro del sistema.</p>
    ...
    <div id="barra">
        <div id="asistente">
	        ...
	        <% if(User.IsInRole("DGAA")){ %>
	            <h3>&Aacute;rea de validaci&oacute;n de producto</h3>
	            <% Html.RenderPartial("_FirmaForm", new FirmaForm { Id = Model.Form.Id, IdName = "DictamenId", Controller = "Dictamen", TipoProducto = 4 }); %>
	        <% } %>
