...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder"
    ...
    <div id="subcontenido">
        <h3>
            Agregar Nueva Reseña</h3>
        <p>
            Puedes agregar una nueva Reseña dentro de la lista de administraci&oacute;n presionando
            en el bot&oacute;n derecho de titulo <strong>+ Crear Reseña</strong>.</p>
        <div class="botonzon">
            <span>
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder"
    ...
    <div id="barra">
        <div id="asistente">
            ...
            <p>
                Lista de Reseña registradas en el sistema.</p>
            ...
            <table>
                ...
                <tr class="highlight">
                    ...
                    <td class="single" width="70%">
                        ...
                        <div class="meta_info">
                            Modificado el
                            <%=Html.Encode(reseña.Modificacion) %></div>
                    </td>
