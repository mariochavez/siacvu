...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="introduccion">
        <p>
            Para modificar el idioma del investigador utilice los siguientes campos para realizar cambios dentro del sistema.
		</p>
...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
	<div id="textos">
	    ...
	    <div id="forma">
	        <% using (Html.BeginForm("Update", "IdiomasInvestigador", new { Id = Model.Form.Id })) { %>
	            <%=Html.AntiForgeryToken() %>
				<%=Html.Hidden("Id", Model.Form.Id) %>
                <%=Html.Hidden("Contexto", "idiomaInvestigacion", new { url = Url.Action("Glosario")}) %>
