...
<p>
	...
	<%=Html.TextBox("Institucion", Model.Institucion, new { @class = "input250", maxlength = 100 })%>
	<%=Html.ValidationMessage("Institucion")%>
</p>
<p>
	<label>Fecha Presentacion:</label>

	<%=Html.TextBox("FechaPresentacion", Model.FechaPresentacion, new { @class = "datetime input100", maxlength = 10 })%>
