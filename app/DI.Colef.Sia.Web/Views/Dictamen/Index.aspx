...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder"
    ...
    <div id="subcontenido">
        <h3>
            Agregar Nuevo Dictamen</h3>
        <p>
            Puedes agregar un nuevo Dictamen dentro de la lista de administraci&oacute;n presionando
            en el bot&oacute;n derecho de titulo <strong>+ Crear Dictamen</strong>.</p>
        <div class="botonzon">
            <span>
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder"
    ...
    <div id="barra">
        <div id="asistente">
            ...
            <p>
                Lista de Dictamenes registrados en el sistema.</p>
            ...
            <table>
                ...
                <tr class="highlight">
                    ...
                    <td class="single" width="70%">
                        ...
                        <div class="meta_info">
                            Modificado el
                            <%=Html.Encode(dictamen.Modificacion) %></div>
                    </td>
