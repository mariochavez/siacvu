    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within DI.Colef.Sia.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within DI.Colef.Sia.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open DI.Colef.Sia.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                DI.Colef.Sia.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
