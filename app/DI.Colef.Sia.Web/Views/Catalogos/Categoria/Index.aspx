        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<CategoriaController>(x => x.New(), "+ Crear Categoria") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">Categorias</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay categorias definidas</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<CategoriaController>(x => x.Edit(categoria.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(categoria.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(categoria.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(categoria.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (categoria.Activo) { %>
                                <span class="btn btn_small_white">
