				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<LineaTematicaController>(x => x.Edit(lineaTematica.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(lineaTematica.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(lineaTematica.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(lineaTematica.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
