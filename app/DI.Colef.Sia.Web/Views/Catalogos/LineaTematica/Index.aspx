...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        <h3>Agregar Nuevo Linea Tematica</h3>
        <p>
            Puede agregar una nueva Linea Tematica dentro de la lista de administraci&oacute;n de
            catalogos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear Linea Tematica</strong>.
		</p>
        <div class="botonzon">
            <span><%=Html.ActionLink<LineaTematicaController>(x => x.New(), "+ Crear Linea Tematica") %></span>
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de Lineas Tematicas registradas en el sistema.</p>
...
<div id="textos">
	...
	<div id="lista">
		<h4>Lineas Tematicas</h4>
            
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay lineas tematicas definidas</span></h5>
