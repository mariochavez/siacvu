...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        ...
        <p>
            ...
            catalogos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear Cargo</strong>.
		</p>
        <div class="botonzon">
            <span><%=Html.ActionLink<CargoController>(x => x.New(), "+ Crear Cargo") %></span>
        </div>
    </div>
</asp:Content>
