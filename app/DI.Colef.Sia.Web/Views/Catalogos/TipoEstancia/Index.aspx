    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<TipoEstanciaController>(x => x.New(), "+ Crear Tipo de Estancia") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">Tipos de Estancias</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay Tipos de Estancias definidas</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<TipoEstanciaController>(x => x.Edit(tipoEstancia.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(tipoEstancia.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(tipoEstancia.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(tipoEstancia.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
