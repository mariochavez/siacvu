        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<GeneroController>(x => x.New(), "+ Crear Genero") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">Generos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay generos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<GeneroController>(x => x.Edit(genero.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(genero.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(genero.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(genero.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (genero.Activo) { %>
                                <span class="btn btn_small_white">
