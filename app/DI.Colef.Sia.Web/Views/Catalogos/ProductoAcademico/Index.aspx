...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        <h3>Agregar nuevo producto acad&eacute;mico</h3>
        <p>
            Puede agregar un nuevo producto acad&eacute;mico dentro de la lista de administraci&oacute;n de
            catalogos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear producto acad&eacute;mico</strong>.
		</p>
        <div class="botonzon">
            <span><%=Html.ActionLink<ProductoAcademicoController>(x => x.New(), "+ Crear producto académico") %></span>
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de productos acad&eacute;micos registrados en el sistema.</p>
		...
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay productos acad&eacute;micos registrados</span></h5>
