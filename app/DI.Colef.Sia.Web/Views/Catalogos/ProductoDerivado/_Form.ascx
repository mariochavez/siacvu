<%@ Control Language="C#" AutoEventWireup="true" Inherits="System.Web.Mvc.ViewUserControl<GenericViewData<ProductoDerivadoForm>>" %>
...
<div id="form">
	...
	<div class="btn_container_footer">
		...
		<span class="btn btn_normal_white">
			<%=Html.ActionLink<ProductoDerivadoController>(x => x.Index(), "Regresar") %>
		</span>
	</div>    
</div>
