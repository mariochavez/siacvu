        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<DepartamentoController>(x => x.New(), "+ Crear Departamento") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">Departamentos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay departamentos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<DepartamentoController>(x => x.Edit(departamento.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(departamento.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(departamento.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(departamento.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
