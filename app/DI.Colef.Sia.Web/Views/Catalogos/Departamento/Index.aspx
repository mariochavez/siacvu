		...
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay departamentos registrados</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var departamento in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(departamento.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(departamento.Nombre) %></span></h5>
						<h6>Modificado el <%=Html.Encode(departamento.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<DepartamentoController>(x => x.Edit(departamento.Id), "Editar") %></span>
	                        <span>
