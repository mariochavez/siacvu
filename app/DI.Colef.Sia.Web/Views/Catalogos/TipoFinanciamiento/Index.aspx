        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<TipoFinanciamientoController>(x => x.New(), "+ Crear Tipo Financiamiento") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">TipoFinanciamientos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay tipoFinanciamientos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<TipoFinanciamientoController>(x => x.Edit(tipoFinanciamiento.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(tipoFinanciamiento.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(tipoFinanciamiento.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(tipoFinanciamiento.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
