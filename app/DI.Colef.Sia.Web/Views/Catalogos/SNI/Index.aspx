    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<SNIController>(x => x.New(), "+ Crear SNI") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">SNIs</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay sNIs definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<SNIController>(x => x.Edit(sNI.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(sNI.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(sNI.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(sNI.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (sNI.Activo) { %>
                                <span class="btn btn_small_white">
