...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        ...
        <p>
            ...
            productos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear Sni</strong>.
		</p>
        <div class="botonzon">
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de Snis registrados en el sistema.</p>
		...
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay snis definidos</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var sNI in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(sNI.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(sNI.Nombre) %></span></h5>
						<h6>Modificado el <%=Html.Encode(sNI.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<SNIController>(x => x.Edit(sNI.Id), "Editar") %></span>
	                        <span>
	                            <% if (sNI.Activo) { %>
