...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        ...
        <p>
            ...
            productos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear Periodo Referencia</strong>.
		</p>
        <div class="botonzon">
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de Periodos Referencias registrados en el sistema.</p>
...
<div id="textos">
	...
	<div id="lista">
		<h4>Periodos Referencias</h4>
            
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay periodos referencias definidos</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var periodoReferencia in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(periodoReferencia.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(periodoReferencia.Periodo) %></span></h5>
						<h6>Modificado el <%=Html.Encode(periodoReferencia.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<PeriodoReferenciaController>(x => x.Edit(periodoReferencia.Id), "Editar") %></span>
	                        <span>
