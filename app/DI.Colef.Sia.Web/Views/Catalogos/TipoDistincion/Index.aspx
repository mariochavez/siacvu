        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<TipoDistincionController>(x => x.New(), "+ Crear Tipo Distincion") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">TipoDistincions</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay tipoDistincions definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<TipoDistincionController>(x => x.Edit(tipoDistincion.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(tipoDistincion.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(tipoDistincion.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(tipoDistincion.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
