...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de dependencias registradas en el sistema.</p>
		...
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay dependencias definidas</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var dependencia in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(dependencia.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(dependencia.Nombre) %></span></h5>
						<h6>Modificado el <%=Html.Encode(dependencia.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<DependenciaController>(x => x.Edit(dependencia.Id), "Editar") %></span>
	                        <span>
