...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="introduccion">
        <p>
            Para modificar el tipo de reporte utilice los siguientes campos para realizar cambios dentro del sistema.
		</p>
...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
	<div id="textos">
	    ...
	    <div id="forma">
	        <% using (Html.BeginForm("Update", "TipoReporte", new { Id = Model.Form.Id })) { %>
