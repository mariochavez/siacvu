...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de identificadores de Libros registrados en el sistema.</p>
...
<div id="textos">
	...
	<div id="lista">
		<h4>Identificadores de Libros</h4>
            
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay identificadores de libros registrados</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var identificadorLibro in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(identificadorLibro.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(identificadorLibro.Nombre) %></span></h5>
						<h6>Modificado el <%=Html.Encode(identificadorLibro.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<IdentificadorLibroController>(x => x.Edit(identificadorLibro.Id), "Editar") %></span>
	                        <span>
