        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<TipoOrganoController>(x => x.New(), "+ Crear Tipo Organo") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">TipoOrganos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay tipoOrganos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<TipoOrganoController>(x => x.Edit(tipoOrgano.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(tipoOrgano.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(tipoOrgano.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(tipoOrgano.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
