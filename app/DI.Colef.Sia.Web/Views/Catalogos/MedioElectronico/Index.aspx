...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        <h3>Agregar Nuevo Medio Electronico</h3>
        <p>
            Puede agregar un nuevo Medio Electronico dentro de la lista de administraci&oacute;n de
            catalogos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear Medio Electronico</strong>.
		</p>
        <div class="botonzon">
            <span><%=Html.ActionLink<MedioElectronicoController>(x => x.New(), "+ Crear Medio Electronico") %></span>
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de Medios Electronicos registrados en el sistema.</p>
		...
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay medios electronicos definidos</span></h5>
