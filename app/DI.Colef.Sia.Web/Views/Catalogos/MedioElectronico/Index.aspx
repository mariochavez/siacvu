        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<MedioElectronicoController>(x => x.New(), "+ Crear Medio Electronico") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">MedioElectronicos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay medioElectronicos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<MedioElectronicoController>(x => x.Edit(medioElectronico.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(medioElectronico.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(medioElectronico.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(medioElectronico.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
