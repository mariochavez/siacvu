    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<IdiomaController>(x => x.New(), "+ Crear Idioma") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">Idiomas</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay idiomas definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<IdiomaController>(x => x.Edit(idioma.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(idioma.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(idioma.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(idioma.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (idioma.Activo) { %>
                                <span class="btn btn_small_white">
