    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<DisciplinaController>(x => x.New(), "+ Crear Disciplina") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">Disciplinas</div>
        <table>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<DisciplinaController>(x => x.Edit(disciplina.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(disciplina.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(disciplina.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(disciplina.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
