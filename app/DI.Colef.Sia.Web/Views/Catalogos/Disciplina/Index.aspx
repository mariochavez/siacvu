...
<asp:Content ID="introductionContent" ContentPlaceHolderID="IntroduccionPlaceHolder" runat="server">
    <div id="subcontenido">
        ...
        <p>
            ...
            catalogos presionando en el bot&oacute;n derecho de t&iacute;tulo <strong>+ Crear Disciplina</strong>.
		</p>
        <div class="botonzon">
            <span><%=Html.ActionLink<DisciplinaController>(x => x.New(), "+ Crear Disciplina") %></span>
        </div>
    </div>
</asp:Content>
