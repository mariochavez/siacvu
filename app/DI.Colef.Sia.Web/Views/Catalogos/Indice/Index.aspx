    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<IndiceController>(x => x.New(), "+ Crear Indice") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">Indices</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay indices definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<IndiceController>(x => x.Edit(indice.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(indice.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(indice.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(indice.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (indice.Activo) { %>
                                <span class="btn btn_small_white">
