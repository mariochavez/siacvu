<%@ Control Language="C#" AutoEventWireup="true" Inherits="System.Web.Mvc.ViewUserControl<GenericViewData<InvestigadorExternoForm>>" %>
...
<div id="form">
    ...
    <table class="form">
        ...
        <tr>
            <td class="label required">
                <label for="Puesto">Puesto:<em>*</em></label>
            </td>
            <td class="field">
                <%=Html.TextBox("Puesto", Model.Form.Puesto, new { @class = "big", size = 10, maxlength = 40 })%>                
	...
	<div class="btn_container_footer">
		...
		<span class="btn btn_normal_white">
			<%=Html.ActionLink<InvestigadorExternoController>(x => x.Index(), "Regresar") %>
		</span>
	</div>    
</div>
