    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<CoautorExternoController>(x => x.New(), "+ Crear Coautor Externo") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">Coautores Externos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay Coautores Externos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<CoautorExternoController>(x => x.Edit(coautorExterno.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(coautorExterno.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(coautorExterno.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(coautorExterno.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
