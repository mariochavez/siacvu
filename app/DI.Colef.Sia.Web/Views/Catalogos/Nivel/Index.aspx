        ...
        <div>
            ...
            <div class="btn_container">
		        <span class="btn btn_medium_brown">
			        <%=Html.ActionLink<NivelController>(x => x.New(), "+ Crear Nivel") %>
		        </span>
	        </div>
	    </div>
        <br />
        <div class="table_title">Nivels</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay nivels definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<NivelController>(x => x.Edit(nivel.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(nivel.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(nivel.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(nivel.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (nivel.Activo) { %>
                                <span class="btn btn_small_white">
