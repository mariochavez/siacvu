    ...
    <div id="datalist">   
        <div class="btn_container">
		    <span class="btn btn_medium_brown">
			    <%=Html.ActionLink<ProyectoController>(x => x.New(), "+ Crear Proyecto") %>
		    </span>
	    </div>
        <br />
        <div class="table_title">Proyectos</div>
        <table>
             <% if(Model.List == null || Model.List.Length == 0) { %>
                <tr>
                    <td>No hay proyectos definidos</td>
                </tr>
            <% } else { %>
				        ...
				        <td class="button" width="46">
					        <div class="floatr btn_container">
						        <span class="btn btn_small_white">
							        <%=Html.ActionLink<ProyectoController>(x => x.Edit(proyecto.Id), "Editar") %>
						        </span>
					        </div>
				        </td>                
                        <td class="single" width="70%">
                            <%=Html.Encode(proyecto.Nombre) %>
                            <div class="meta_info">Modificado el <%=Html.Encode(proyecto.Modificacion) %></div>
                        </td>
                        <td id="accion_<%=Html.Encode(proyecto.Id) %>" class="button" width="140">
                            <div class="floatr btn_container">
                            <% if (proyecto.Activo) { %>
                                <span class="btn btn_small_white">
