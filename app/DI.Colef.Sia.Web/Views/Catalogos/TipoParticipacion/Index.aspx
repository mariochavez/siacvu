...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de Tipos de Participaci&oacute;n registradas en el sistema.</p>
...
<div id="textos">
	...
	<div id="lista">
		<h4>Tipos de Participaci&oacute;n</h4>
            
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay tipos de participaci&oacute;n definidas</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var tipoParticipacion in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(tipoParticipacion.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(tipoParticipacion.Nombre) %></span></h5>
						<h6>Modificado el <%=Html.Encode(tipoParticipacion.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<TipoParticipacionController>(x => x.Edit(tipoParticipacion.Id), "Editar") %></span>
	                        <span>
