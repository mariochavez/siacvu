...
<<<<<<< HEAD:db/DbSchema.sql
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKBA4F3E8A85102A57]') AND parent_object_id = OBJECT_ID('TipoEstudiantes'))
alter table TipoEstudiantes  drop constraint FKBA4F3E8A85102A57


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKBA4F3E8A74E8BAB7]') AND parent_object_id = OBJECT_ID('TipoEstudiantes'))
alter table TipoEstudiantes  drop constraint FKBA4F3E8A74E8BAB7
=======
...
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
...
alter table TesisDirigidas  drop constraint FKEF4DD3117A8488F7
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEF4DD311103EADB1]') AND parent_object_id = OBJECT_ID('TesisDirigidas'))
alter table TesisDirigidas  drop constraint FKEF4DD311103EADB1
...
alter table TesisDirigidas  drop constraint FKEF4DD3115ECF193D
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEF4DD3111EDC2D3B]') AND parent_object_id = OBJECT_ID('TesisDirigidas'))
alter table TesisDirigidas  drop constraint FKEF4DD3111EDC2D3B


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEF4DD31111666E2A]') AND parent_object_id = OBJECT_ID('TesisDirigidas'))
alter table TesisDirigidas  drop constraint FKEF4DD31111666E2A
...
alter table TesisDirigidas  drop constraint FKEF4DD3113E082BED
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEF4DD31188D0C162]') AND parent_object_id = OBJECT_ID('TesisDirigidas'))
alter table TesisDirigidas  drop constraint FKEF4DD31188D0C162
...
alter table Distinciones  drop constraint FKEF821EECC0410E89
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEF821EEC11666E2A]') AND parent_object_id = OBJECT_ID('Distinciones'))
alter table Distinciones  drop constraint FKEF821EEC11666E2A
...
alter table GrupoInvestigaciones  drop constraint FK742C6D09C8628149
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK742C6D09C85D8149]') AND parent_object_id = OBJECT_ID('GrupoInvestigaciones'))
alter table GrupoInvestigaciones  drop constraint FK742C6D09C85D8149


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK742C6D09C8588149]') AND parent_object_id = OBJECT_ID('GrupoInvestigaciones'))
alter table GrupoInvestigaciones  drop constraint FK742C6D09C8588149


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK742C6D09C85B8149]') AND parent_object_id = OBJECT_ID('GrupoInvestigaciones'))
alter table GrupoInvestigaciones  drop constraint FK742C6D09C85B8149


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK742C6D09C85E8149]') AND parent_object_id = OBJECT_ID('GrupoInvestigaciones'))
alter table GrupoInvestigaciones  drop constraint FK742C6D09C85E8149
...
alter table Proyectos  drop constraint FK8BA36D77B44F9F1
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D7776D4A4B8]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D7776D4A4B8
...
alter table Proyectos  drop constraint FK8BA36D77D1445B26
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D774981DBA6]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D774981DBA6
...
alter table Proyectos  drop constraint FK8BA36D77C8628149
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D77C85D8149]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D77C85D8149


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D77C8588149]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D77C8588149


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D77C85B8149]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D77C85B8149


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D77C85E8149]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D77C85E8149
...
alter table EstadoPaises  drop constraint FKD3B80B5274E8BAB7
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK18D9F63F85102A57]') AND parent_object_id = OBJECT_ID('Ediciones'))
alter table Ediciones  drop constraint FK18D9F63F85102A57


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK18D9F63F74E8BAB7]') AND parent_object_id = OBJECT_ID('Ediciones'))
alter table Ediciones  drop constraint FK18D9F63F74E8BAB7
...
alter table SNIInvestigadores  drop constraint FK6A7A949C8336201B
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKF31F01B78336201B]') AND parent_object_id = OBJECT_ID('ResponsableInternoProductos'))
alter table ResponsableInternoProductos  drop constraint FKF31F01B78336201B


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKF31F01B785102A57]') AND parent_object_id = OBJECT_ID('ResponsableInternoProductos'))
alter table ResponsableInternoProductos  drop constraint FKF31F01B785102A57


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKF31F01B774E8BAB7]') AND parent_object_id = OBJECT_ID('ResponsableInternoProductos'))
alter table ResponsableInternoProductos  drop constraint FKF31F01B774E8BAB7


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK550E475645769F82]') AND parent_object_id = OBJECT_ID('ResponsableInternoCapitulo'))
alter table ResponsableInternoCapitulo  drop constraint FK550E475645769F82


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK550E4756A1B3F60D]') AND parent_object_id = OBJECT_ID('ResponsableInternoCapitulo'))
alter table ResponsableInternoCapitulo  drop constraint FK550E4756A1B3F60D


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK5D335A858FDBB774]') AND parent_object_id = OBJECT_ID('ResponsableExternoProductos'))
alter table ResponsableExternoProductos  drop constraint FK5D335A858FDBB774


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK5D335A85103EADB1]') AND parent_object_id = OBJECT_ID('ResponsableExternoProductos'))
alter table ResponsableExternoProductos  drop constraint FK5D335A85103EADB1


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK5D335A8585102A57]') AND parent_object_id = OBJECT_ID('ResponsableExternoProductos'))
alter table ResponsableExternoProductos  drop constraint FK5D335A8585102A57


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK5D335A8574E8BAB7]') AND parent_object_id = OBJECT_ID('ResponsableExternoProductos'))
alter table ResponsableExternoProductos  drop constraint FK5D335A8574E8BAB7


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEB68948AB7DD3410]') AND parent_object_id = OBJECT_ID('ResponsableExternoCapitulo'))
alter table ResponsableExternoCapitulo  drop constraint FKEB68948AB7DD3410


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEB68948AA1B3F60D]') AND parent_object_id = OBJECT_ID('ResponsableExternoCapitulo'))
alter table ResponsableExternoCapitulo  drop constraint FKEB68948AA1B3F60D
...
alter table Eventos  drop constraint FK9DD523431EDC2D3B
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK9DD5234311666E2A]') AND parent_object_id = OBJECT_ID('Eventos'))
alter table Eventos  drop constraint FK9DD5234311666E2A
...
alter table MovilidadAcademicas  drop constraint FK684440B0201EE7BB
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK684440B06A829E09]') AND parent_object_id = OBJECT_ID('MovilidadAcademicas'))
alter table MovilidadAcademicas  drop constraint FK684440B06A829E09
...
alter table TipoReportes  drop constraint FK6D81574574E8BAB7
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKB00C335E85102A57]') AND parent_object_id = OBJECT_ID('SectorFinanciamientos'))
alter table SectorFinanciamientos  drop constraint FKB00C335E85102A57


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKB00C335E74E8BAB7]') AND parent_object_id = OBJECT_ID('SectorFinanciamientos'))
alter table SectorFinanciamientos  drop constraint FKB00C335E74E8BAB7
...
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
    ...
    if exists (select * from dbo.sysobjects where id = object_id(N'Ediciones') and OBJECTPROPERTY(id, N'IsUserTable') = 1) drop table Ediciones
...
alter table Instituciones  drop constraint FK7E69627C74E8BAB7
=======
    if exists (select * from dbo.sysobjects where id = object_id(N'ResponsableExternoProductos') and OBJECTPROPERTY(id, N'IsUserTable') = 1) drop table ResponsableExternoProductos
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql

    if exists (select * from dbo.sysobjects where id = object_id(N'ResponsableExternoCapitulo') and OBJECTPROPERTY(id, N'IsUserTable') = 1) drop table ResponsableExternoCapitulo
...
=======
    ...
    if exists (select * from dbo.sysobjects where id = object_id(N'TipoEstudiantes') and OBJECTPROPERTY(id, N'IsUserTable') = 1) drop table TipoEstudiantes
    ...
    if exists (select * from dbo.sysobjects where id = object_id(N'SectorFinanciamientos') and OBJECTPROPERTY(id, N'IsUserTable') = 1) drop table SectorFinanciamientos
...
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
        Id INT IDENTITY NOT NULL,
       Nombre NVARCHAR(255) null,
       LineaTematicaInstitucional BIT null,
       CreadorEl DATETIME null,
       ModificadoEl DATETIME null,
       Activo BIT null,
       CreadorPorFk INT null,
...
=======
    ...
    create table ResponsableInternoCapitulo (
        ResponsableInternoProducto INT not null,
       CapituloFk INT null,
       primary key (ResponsableInternoProducto)
    )

    create table ResponsableExternoProductos (
        Id INT IDENTITY NOT NULL,
       TipoProducto INT not null,
       CreadorEl DATETIME null,
       ModificadoEl DATETIME null,
...
=======
    create table ResponsableExternoCapitulo (
        ResponsableExternoProducto INT not null,
       CapituloFk INT null,
       primary key (ResponsableExternoProducto)
    )
...
=======
    create table SectorFinanciamientos (
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
        Id INT IDENTITY NOT NULL,
       Nombre NVARCHAR(255) null,
       CreadorEl DATETIME null,
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table TipoEstudiantes 
        add constraint FKBA4F3E8A85102A57 
        foreign key (CreadorPorFk) 
        references Usuarios

    alter table TipoEstudiantes 
        add constraint FKBA4F3E8A74E8BAB7 
=======
    alter table SNIs 
...
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
    ...
    alter table Monedas 
        add constraint FK34FE812074E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table FormacionAcademicas 
        add constraint FK824D8BEA6A829E09 
...
=======
    ...
    alter table EstatusProyectos 
        add constraint FKDE910ADD74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
    ...
    alter table ProductoAcademicos 
        add constraint FKE85C13AA74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table AreaTematicas 
        add constraint FK33E5D7A574E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
=======
    alter table Participaciones 
        add constraint FK56CA0A1B6A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table ApoyoConacyts 
        add constraint FK9114F616A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
    ...
    alter table ApoyoConacyts 
        add constraint FK9114F6174E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
=======
    ...
    alter table TipoArchivos 
        add constraint FKDDAB43C074E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table GrupoInvestigaciones 
        add constraint FK742C6D09C85D8149 
        foreign key (Nivel3Fk) 
        references Niveles

    alter table GrupoInvestigaciones 
        add constraint FK742C6D09C8588149 
        foreign key (Nivel4Fk) 
        references Niveles

    alter table GrupoInvestigaciones 
        add constraint FK742C6D09C85B8149 
    ...
    alter table GrupoInvestigaciones 
        add constraint FK742C6D0974E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table USEGs 
        add constraint FKD8A4EC8574E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table Reportes 
        add constraint FK26728BE16A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
...
=======
    ...
    alter table ResponsableInternoProyectos 
        add constraint FK1BD3EE0774E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table TesisDirigidas 
        add constraint FKEF4DD311103EADB1 
        foreign key (FormaParticipacionFk) 
        references FormaParticipaciones
    ...
    alter table TesisDirigidas 
        add constraint FKEF4DD3111EDC2D3B 
        foreign key (LineaTematicaFk) 
        references LineaTematicas

    alter table TesisDirigidas 
        add constraint FKEF4DD31111666E2A 
        foreign key (PeriodoReferenciaFk) 
        references PeriodoReferencias
    ...
    alter table TesisDirigidas 
        add constraint FKEF4DD31188D0C162 
    ...
    alter table TesisDirigidas 
        add constraint FKEF4DD3116A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
    ...
    alter table TesisDirigidas 
        add constraint FKEF4DD31174E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table Cursos 
        add constraint FK8E38D63E6A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
    ...
    alter table SubprogramaConacyts 
        add constraint FKC30604C874E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table Firmas 
        add constraint FK1BC2D59F6EC29E1E 
        foreign key (Usuario1Fk) 
        references Usuarios

    alter table Firmas 
        add constraint FK1BC2D59FCC939E1E 
        foreign key (Usuario2Fk) 
        references Usuarios

    alter table Firmas 
        add constraint FK1BC2D59F470C9E1E 
    ...
    alter table Distinciones 
        add constraint FKEF821EEC11666E2A 
        foreign key (PeriodoReferenciaFk) 
        references PeriodoReferencias

    alter table Distinciones 
        add constraint FKEF821EEC6A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
...
=======
    ...
    alter table Ediciones 
        add constraint FK18D9F63F85102A57 
        foreign key (CreadorPorFk) 
        references Usuarios

    alter table Ediciones 
        add constraint FK18D9F63F74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ResponsableInternoProductos 
        add constraint FKF31F01B774E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios

    alter table ResponsableInternoCapitulo 
        add constraint FK550E475645769F82 
        foreign key (ResponsableInternoProducto) 
        references ResponsableInternoProductos

    alter table ResponsableInternoCapitulo 
        add constraint FK550E4756A1B3F60D 
        foreign key (CapituloFk) 
        references Capitulos

    alter table ResponsableExternoProductos 
        add constraint FK5D335A858FDBB774 
        foreign key (InvestigadorExternoFk) 
        references InvestigadorExternos

    alter table ResponsableExternoProductos 
        add constraint FK5D335A85103EADB1 
        foreign key (FormaParticipacionFk) 
        references FormaParticipaciones

    alter table ResponsableExternoProductos 
        add constraint FK5D335A8585102A57 
        foreign key (CreadorPorFk) 
        references Usuarios

    alter table ResponsableExternoProductos 
        add constraint FK5D335A8574E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios

    alter table ResponsableExternoCapitulo 
        add constraint FKEB68948AB7DD3410 
        foreign key (ResponsableExternoProducto) 
        references ResponsableExternoProductos

    alter table ResponsableExternoCapitulo 
        add constraint FKEB68948AA1B3F60D 
        foreign key (CapituloFk) 
        references Capitulos
    ...
    alter table ExperienciaProfesionales 
        add constraint FK4F93B3CC6A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
    ...
    alter table ExperienciaProfesionales 
        add constraint FK4F93B3CC74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table Eventos 
        add constraint FK9DD5234311666E2A 
        foreign key (PeriodoReferenciaFk) 
        references PeriodoReferencias
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table MovilidadAcademicas 
        add constraint FK684440B06A829E09 
        foreign key (UsuarioFk) 
        references Usuarios
    ...
    alter table ImpactoPoliticaPublicas 
        add constraint FKC9393CDB74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table TipoApoyos 
        add constraint FKAE84C80474E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table Ramas 
        add constraint FKEA27DBAA74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table DirigidoAs 
        add constraint FK6708195574E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ActividadPrevistas 
        add constraint FKBA04838774E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
...
=======
    ...
    alter table SectorFinanciamientos 
        add constraint FKB00C335E85102A57 
        foreign key (CreadorPorFk) 
        references Usuarios

    alter table SectorFinanciamientos 
        add constraint FKB00C335E74E8BAB7 
>>>>>>> 5562b99b383623c798c25aa7423285aa892ce892:db/DbSchema.sql
        foreign key (ModificadoPorFk) 
        references Usuarios
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table CoautorInternoProductos 
        add constraint FKCAE46D9C74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table CoautorExternoProductos 
        add constraint FK15D3B7B274E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table Proyectos 
        add constraint FK8BA36D7776D4A4B8 
        foreign key (SectorFinanciamientoFk) 
        references SectorFinanciamientos
    ...
    alter table Proyectos 
        add constraint FK8BA36D774981DBA6 
        foreign key (TipoEstudianteFk) 
        references TipoEstudiantes
    ...
    alter table Proyectos 
        add constraint FK8BA36D77C85D8149 
        foreign key (Nivel3Fk) 
        references Niveles

    alter table Proyectos 
        add constraint FK8BA36D77C8588149 
        foreign key (Nivel4Fk) 
        references Niveles

    alter table Proyectos 
        add constraint FK8BA36D77C85B8149 
        foreign key (Nivel5Fk) 
        references Niveles

    alter table Proyectos 
        add constraint FK8BA36D77C85E8149 
        foreign key (Nivel6Fk) 
        references Niveles
...
<<<<<<< HEAD:db/DbSchema.sql
    ...
    alter table ParticipacionAcademias 
        add constraint FK23DC16D074E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
