...
alter table EstanciaAcademicaExternas  drop constraint FK43CB631564F7D1CD
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK43CB631542C8DD29]') AND parent_object_id = OBJECT_ID('EstanciaAcademicaExternas'))
alter table EstanciaAcademicaExternas  drop constraint FK43CB631542C8DD29
...
alter table ArticuloDifusiones  drop constraint FKCDA70A4F4FE4035
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKCDA70A44C8A2228]') AND parent_object_id = OBJECT_ID('ArticuloDifusiones'))
alter table ArticuloDifusiones  drop constraint FKCDA70A44C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKCDA70A4FA2FB61A]') AND parent_object_id = OBJECT_ID('ArticuloDifusiones'))
alter table ArticuloDifusiones  drop constraint FKCDA70A4FA2FB61A
...
alter table Idiomas  drop constraint FKB635BD3C74E8BAB7
    ...
    alter table EstanciaAcademicaExternas 
        add constraint FK43CB631542C8DD29 
    ...
    alter table ArticuloDifusiones 
        add constraint FKCDA70A44C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table ArticuloDifusiones 
        add constraint FKCDA70A4FA2FB61A 
    ...
    alter table ArticuloDifusiones 
        add constraint FKCDA70A46A829E09 
        foreign key (UsuarioFk) 
        references Usuarios

    alter table ArticuloDifusiones 
        add constraint FKCDA70A462D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table ArticuloDifusiones 
        add constraint FKCDA70A474E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
