...
alter table Libros  drop constraint FK439120E7295BC133
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK439120E74C8A2228]') AND parent_object_id = OBJECT_ID('Libros'))
alter table Libros  drop constraint FK439120E74C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK439120E725204D14]') AND parent_object_id = OBJECT_ID('Libros'))
alter table Libros  drop constraint FK439120E725204D14


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK439120E71F304754]') AND parent_object_id = OBJECT_ID('Libros'))
alter table Libros  drop constraint FK439120E71F304754
...
alter table Resenas  drop constraint FKF708AE62CB4F3F6C
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKF708AE624C8A2228]') AND parent_object_id = OBJECT_ID('Resenas'))
alter table Resenas  drop constraint FKF708AE624C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKF708AE6225204D14]') AND parent_object_id = OBJECT_ID('Resenas'))
alter table Resenas  drop constraint FKF708AE6225204D14


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKF708AE62B29B90A1]') AND parent_object_id = OBJECT_ID('Resenas'))
alter table Resenas  drop constraint FKF708AE62B29B90A1
...
alter table Reportes  drop constraint FK26728BE1CB4F3F6C
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK26728BE14C8A2228]') AND parent_object_id = OBJECT_ID('Reportes'))
alter table Reportes  drop constraint FK26728BE14C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK26728BE125204D14]') AND parent_object_id = OBJECT_ID('Reportes'))
alter table Reportes  drop constraint FK26728BE125204D14


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK26728BE1885B06C7]') AND parent_object_id = OBJECT_ID('Reportes'))
alter table Reportes  drop constraint FK26728BE1885B06C7
...
alter table Proyectos  drop constraint FK8BA36D77CB4F3F6C
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK8BA36D777857EA4B]') AND parent_object_id = OBJECT_ID('Proyectos'))
alter table Proyectos  drop constraint FK8BA36D777857EA4B
...
alter table ObraTraducidas  drop constraint FK1A338EFCCB4F3F6C
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK1A338EFC4C8A2228]') AND parent_object_id = OBJECT_ID('ObraTraducidas'))
alter table ObraTraducidas  drop constraint FK1A338EFC4C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK1A338EFC25204D14]') AND parent_object_id = OBJECT_ID('ObraTraducidas'))
...
alter table Capitulos  drop constraint FK3165FEADCB4F3F6C
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK3165FEAD4C8A2228]') AND parent_object_id = OBJECT_ID('Capitulos'))
alter table Capitulos  drop constraint FK3165FEAD4C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK3165FEAD25204D14]') AND parent_object_id = OBJECT_ID('Capitulos'))
alter table Capitulos  drop constraint FK3165FEAD25204D14


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK3165FEAD8A2373AB]') AND parent_object_id = OBJECT_ID('Capitulos'))
alter table Capitulos  drop constraint FK3165FEAD8A2373AB
...
alter table Articulos  drop constraint FK3EB394D7F4FE4035
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK3EB394D74C8A2228]') AND parent_object_id = OBJECT_ID('Articulos'))
alter table Articulos  drop constraint FK3EB394D74C8A2228


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK3EB394D725204D14]') AND parent_object_id = OBJECT_ID('Articulos'))
alter table Articulos  drop constraint FK3EB394D725204D14


    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK3EB394D7FA2FB61A]') AND parent_object_id = OBJECT_ID('Articulos'))
alter table Articulos  drop constraint FK3EB394D7FA2FB61A
...
alter table AreaInvestigaciones  drop constraint FKC1B18FE674E8BAB7
    ...
    alter table Libros 
        add constraint FK439120E74C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table Libros 
        add constraint FK439120E725204D14 
        foreign key (ComprobantePublicadoFk) 
        references Archivos

    alter table Libros 
        add constraint FK439120E71F304754 
    ...
    alter table Resenas 
        add constraint FKF708AE624C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table Resenas 
        add constraint FKF708AE6225204D14 
        foreign key (ComprobantePublicadoFk) 
        references Archivos

    alter table Resenas 
        add constraint FKF708AE62B29B90A1 
    ...
    alter table Reportes 
        add constraint FK26728BE14C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table Reportes 
        add constraint FK26728BE125204D14 
        foreign key (ComprobantePublicadoFk) 
        references Archivos

    alter table Reportes 
        add constraint FK26728BE1885B06C7 
    ...
    alter table Proyectos 
        add constraint FK8BA36D777857EA4B 
    ...
    alter table CursoInvestigadores 
        add constraint FKD4AFE6592BAFDC96 
        foreign key (NivelEstudioFk) 
        references NivelEstudios

    alter table CursoInvestigadores 
        add constraint FKD4AFE6593E082BED 
        foreign key (SectorFk) 
        references Sectores

    alter table CursoInvestigadores 
        add constraint FKD4AFE659EC222BA6 
        foreign key (OrganizacionFk) 
        references Organizaciones

    alter table CursoInvestigadores 
        add constraint FKD4AFE659C8628149 
        foreign key (Nivel2Fk) 
        references Niveles

    alter table CursoInvestigadores 
        add constraint FKD4AFE659295BC133 
        foreign key (AreaFk) 
        references Areas

    alter table CursoInvestigadores 
        add constraint FKD4AFE659BC063744 
        foreign key (DisciplinaFk) 
        references Disciplinas

    alter table CursoInvestigadores 
        add constraint FKD4AFE659F4FE4035 
        foreign key (SubdisciplinaFk) 
        references Subdisciplinas
    ...
    alter table SesionEventos 
        add constraint FK6942327562D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table SesionEventos 
        add constraint FK6942327574E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ParticipanteInternoProductos 
        add constraint FKEFE230DD62D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table ParticipanteInternoProductos 
        add constraint FKEFE230DD74E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ParticipanteExternoProductos 
        add constraint FKB9FA413662D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table ParticipanteExternoProductos 
        add constraint FKB9FA413674E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ResponsableProyectos 
        add constraint FK8A3F719862D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table ResponsableProyectos 
        add constraint FK8A3F719874E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ObraTraducidas 
        add constraint FK1A338EFC4C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table ObraTraducidas 
        add constraint FK1A338EFC25204D14 
        foreign key (ComprobantePublicadoFk) 
        references Archivos
    ...
    alter table Capitulos 
        add constraint FK3165FEAD4C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table Capitulos 
        add constraint FK3165FEAD25204D14 
        foreign key (ComprobantePublicadoFk) 
        references Archivos

    alter table Capitulos 
        add constraint FK3165FEAD8A2373AB 
    ...
    alter table TesisPosgrados 
        add constraint FKD989B32864F7D1CD 
        foreign key (InstitucionFk) 
        references Instituciones

    alter table TesisPosgrados 
        add constraint FKD989B3283E082BED 
        foreign key (SectorFk) 
        references Sectores

    alter table TesisPosgrados 
        add constraint FKD989B328EC222BA6 
        foreign key (OrganizacionFk) 
        references Organizaciones

    alter table TesisPosgrados 
        add constraint FKD989B328C8628149 
        foreign key (Nivel2Fk) 
        references Niveles
    ...
    alter table Articulos 
        add constraint FK3EB394D74C8A2228 
        foreign key (ComprobanteAceptadoFk) 
        references Archivos

    alter table Articulos 
        add constraint FK3EB394D725204D14 
        foreign key (ComprobantePublicadoFk) 
        references Archivos

    alter table Articulos 
        add constraint FK3EB394D7FA2FB61A 
    ...
    alter table EstudianteProyectos 
        add constraint FK235213B862D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table EstudianteProyectos 
        add constraint FK235213B874E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
    ...
    alter table ProductoGeneradoProyectos 
        add constraint FK86521C0462D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios

    alter table ProductoGeneradoProyectos 
        add constraint FK86521C0474E8BAB7 
        foreign key (ModificadoPorFk) 
        references Usuarios
