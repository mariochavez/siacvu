...
alter table TipoEventos  drop constraint FK952D666B74E8BAB7
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FKEF8D374162D605DB]') AND parent_object_id = OBJECT_ID('OtraParticipaciones'))
alter table OtraParticipaciones  drop constraint FKEF8D374162D605DB
...
alter table Participaciones  drop constraint FK56CA0A1BC0410E89
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK56CA0A1B62D605DB]') AND parent_object_id = OBJECT_ID('Participaciones'))
alter table Participaciones  drop constraint FK56CA0A1B62D605DB
...
alter table ApoyoConacyts  drop constraint FK9114F6174E8BAB7
    ...
    if exists (select 1 from sys.objects where object_id = OBJECT_ID(N'[FK900A4EAC62D605DB]') AND parent_object_id = OBJECT_ID('TipoPresentaciones'))
alter table TipoPresentaciones  drop constraint FK900A4EAC62D605DB
...
alter table CargoInvestigadores  drop constraint FKC1D5F88D8336201B
    ...
    alter table TesisPosgrados 
        add constraint FKD989B328295BC133 
        foreign key (AreaFk) 
        references Areas

    alter table TesisPosgrados 
        add constraint FKD989B328BC063744 
        foreign key (DisciplinaFk) 
        references Disciplinas
    ...
    alter table OtraParticipaciones 
        add constraint FKEF8D374162D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios
    ...
    alter table Participaciones 
        add constraint FK56CA0A1B62D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios
    ...
    alter table TipoPresentaciones 
        add constraint FK900A4EAC62D605DB 
        foreign key (CreadoPorFk) 
        references Usuarios
