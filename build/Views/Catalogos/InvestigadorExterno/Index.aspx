...
<asp:Content ID="sidebarContent" ContentPlaceHolderID="SidebarContentPlaceHolder" runat="server">
    <div id="barra">
        <div id="asistente">
            ...
            <p>Lista de investigadores Externos registrados en el sistema.</p>
...
<div id="textos">
	...
	<div id="lista">
		<h4>Investigadores Externos</h4>
            
		<% if (Model.List == null || Model.List.Length == 0) { %>
			<div class="elementolista">
				<div class="elementodescripcion">
					<h5><span>No hay investigadores externos registrados</span></h5>
				</div><!--end elementodescripcion-->

			</div><!--end elementolista-->
		<% } else { %>
			<% foreach (var investigadorExterno in Model.List) { %>
				<div class="elementolista" id="accion_<%=Html.Encode(investigadorExterno.Id) %>">
					<div class="elementodescripcion">
						<h5><span><%=Html.Encode(investigadorExterno.Nombre) %></span></h5>
						<h6>Modificado el <%=Html.Encode(investigadorExterno.Modificacion) %></h6>
					</div><!--end elementodescripcion-->

					<div class="elementobotones">
						<p>
							<span><%=Html.ActionLink<InvestigadorExternoController>(x => x.Edit(investigadorExterno.Id), "Editar") %></span>
	                        <span>
